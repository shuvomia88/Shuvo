...
async def send_admin_dashboard(bot, chat_id: int, lang: str):
    ...
    btn_ig_file = InlineKeyboardButton("📷 Instagram File", callback_data="adm_ig_file")
    btn_fb_file = InlineKeyboardButton("📘 Facebook File", callback_data="adm_fb_file")
...
async def admin_send_file_dump(bot, chat_id: int, category: str):
    """Instagram/Facebook File বাটনের জন্য Excel এক্সপোর্ট লজিক (টেক্সট ও ইনলাইন — দুই জায়গা থেকেই কল হয়)।"""
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if target_task:
        ...
        bold_rules = build_bold_entity(rules_msg, "Rules:")
...
async def callback_query(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id == ADMIN_ID and data in [
        ...
        "adm_ig_file", "adm_fb_file", "adm_work_video", "adm_back",
    ]:
        ...
        elif data == "adm_ig_file":
            await admin_send_file_dump(context.bot, user_id, "instagram")

        elif data == "adm_fb_file":
            await admin_send_file_dump(context.bot, user_id, "facebook")
